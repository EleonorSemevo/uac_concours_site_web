...
<div  >
  <div class="container-fluid" style="height: 500px;" >
    <div class="row align-items-center" style=" color: white; background-image: url('{{ asset('/images/question.jpg')}}'); height: 500px;">
        <div class="col"></div>
        <div class="col" ><h1>Foire aux questions</h1></div>
        <div class="col"></div>
    </div>
                ...
                <div class="card-body">
                  <form action="#">
                    <div class="form-group d-flex search-field">
                      <input type="text" class="form-control" placeholder="Chercher ici " value="Questions">
